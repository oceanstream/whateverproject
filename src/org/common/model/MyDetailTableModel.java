...
public class MyDetailTableModel extends AbstractTableModel{
	...
	public MyDetailTableModel(Order order){
		this.order = order;
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		try{
			switch(columnIndex){
			case 0:
				return list_dish.get(rowIndex).getName();
			case 1:
			...
			case 3:
				return list_semi.get(rowIndex).getScale();
			case 4:
